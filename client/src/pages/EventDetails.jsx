...
const EventDetails = () => {
    ...
    useEffect(() => {
        const checkBooking = async () => {
            ...
            try {
                ...
                const booking = data.find(b => b.eventId._id === id && b.status !== 'cancelled');
                if (booking) setAlreadyBooked(true);
            } catch (err) {
    ...
    const handleBooking = async () => {
        ...
        try {
            if (!showOTP) {
                ...
                setShowOTP(true);
                setSuccessMsg('OTP sent to your email. Please verify to confirm booking.Check in spam folder.');
            } else {
    ...
    const isSoldOut = event.availableSeats <= 0 || alreadyBooked;
            ...
            <div className="p-8 md:p-12">
                <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-6">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 min-w-[300px] w-full md:w-auto shrink-0 shadow-sm">
                        ...
                        >
                            {bookingLoading
                                ? 'Processing...': showOTP? 'Verify OTP & Confirm': alreadyBooked? 'Already Booked' : isSoldOut? 'Sold Out' : 'Confirm Registration'}
                        </button>
