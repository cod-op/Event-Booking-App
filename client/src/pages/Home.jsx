      ...
      <div className="relative bg-black text-white overflow-hidden mb-12 shadow-2xl">
        ...
        <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
          ...
          <div className="w-full max-w-2xl mx-auto relative flex items-center shadow-2xl group">
            <FaSearch className="absolute left-6 z-10 text-gray-500 text-xl group-focus-within:text-black transition-colors" />
            <input
              type="text"
              placeholder="Search events by title..."
              className="w-full pl-16 pr-6 py-2 rounded-full text-lg text-black bg-white/95 backdrop-blur-sm border-2 border-transparent focus:border-gray-500 focus:outline-none transition-all placeholder-gray-400 font-medium"
              value={search}
